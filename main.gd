...
func _on_midi_event(midi_event: DistrhoMidiEvent) -> void:
	print(
		"MIDI Event: channel: ", midi_event.channel,
		" status: ", midi_event.status,
		" data1: ", midi_event.data1,
		" data2: ", midi_event.data2,
		" frame: ", midi_event.frame
	)
...
func _on_midi_program_change(channel: int, program: int, frame: int) -> void:
	print(
		"Program Change: channel: ", channel,
		" program: ", program,
		" frame: ", frame
	)
