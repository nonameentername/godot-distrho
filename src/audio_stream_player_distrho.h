#ifndef AUDIO_STREAM_PLAYER_DISTRHO_H
#define AUDIO_STREAM_PLAYER_DISTRHO_H
...
class AudioStreamPlaybackDistrho : public AudioStreamPlayback {
    GDCLASS(AudioStreamPlaybackDistrho, AudioStreamPlayback)
    friend class AudioStreamDistrho;

private:
    Ref<AudioStreamDistrho> base;
    bool active;
