...
void DistrhoUIClient::edit_parameter(int p_index, bool p_started) {
    capnp::FlatArrayMessageReader reader =
        rpc_call<EditParameterRequest, EditParameterResponse>([p_index, p_started](auto &request) {
...
void DistrhoUIClient::set_parameter_value(int p_index, float p_value) {
    capnp::FlatArrayMessageReader reader =
        rpc_call<SetParameterValueRequest, SetParameterValueResponse>([p_index, p_value](auto &request) {
            request.setIndex(p_index);
...
void DistrhoUIClient::send_note(int p_channel, int p_note, int p_velocity) {
    capnp::FlatArrayMessageReader reader =
        rpc_call<SendNoteRequest, SendNoteResponse>([p_channel, p_note, p_velocity](auto &request) {
