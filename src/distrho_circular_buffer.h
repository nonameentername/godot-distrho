 ...
 */
int distrhoReadCircularBuffer(void *circular_buffer, void *out, int items);
 ...
 * @returns the actual number of items read (0 <= n <= items)
 */
int distrhoPeekCircularBuffer(void *circular_buffer, void *out, int items);
 ...
 */
int distrhoWriteCircularBuffer(void *p, const void *inp, int items);
/**
 ...
 */
void distrhoDestroyCircularBuffer(void *circularbuffer);
/** @}*/
